...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "University of Galway"
Config.profilename = ""
Config.url = " \
    ""http://www.universityofgalway.ie/information-solutions-services/servicesforstaff/wifi/eduroam/"
Config.email = "servicedesk@universityofgalway.ie"
Config.title = "eduroam CAT"
Config.server_match = "idp-managed-radius.nuigalway.ie"
...
Config.user_realm = "universityofgalway.ie"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:idp-managed-radius.nuigalway.ie']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@universityofgalway.ie"
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
